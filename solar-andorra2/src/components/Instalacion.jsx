...
export const Instalacion = () => {
  return (
    ...
    <div className="h-full w-full max-w-7xl pt-10 md:mx-auto" >
      <h4 className=" text-green-500 text-md font-bold text-left p-4 uppercase">El proceso</h4>
        <h3 className="text-2xl md:text-5xl font-bold text-left pl-4">¿Cómo es una instalación de placas solares en una vivienda?</h3>
     <div className="flex flex-col md:flex-row justify-between h-full w-full text-center items-center py-5">
      <div className="md:w-4/5 p-4 border-r-indigo-300">
